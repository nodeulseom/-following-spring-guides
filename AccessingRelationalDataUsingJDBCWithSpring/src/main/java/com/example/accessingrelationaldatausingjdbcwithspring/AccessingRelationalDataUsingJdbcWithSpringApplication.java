...
//                "id SERIAL, first_name VARCHAR(255), last_name(255))");
                "id IDENTITY, first_name BIGSERIAL, last_name SERIAL)");
        ...
        // User JdbcTemplate's batchUpdate operation to bulk load data
